...
async function createTestBuyer() {
  try {
    console.log('🔧 Creando comprador de prueba...');
    
    const timestamp = Date.now();
    const testEmail = `comprador.${timestamp}@gmail.com`;
    const testPassword = 'password123';
    
    console.log(`📧 Creando comprador: ${testEmail}`);
    ...
    if (signUpData.user) {
      ...
      console.log('👤 Creando perfil de comprador...');
