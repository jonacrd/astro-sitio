  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        priceCents: 39990,
        stock: 10,
        imageUrl: 'https://images.unsplash.com/photo-1506629905607-1b8b4b4b4b4b?w=500&h=500&fit=crop&auto=format'
      },
      {
    ...
    products: [
      {
        ...
        priceCents: 299990,
        stock: 6,
        imageUrl: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=500&h=500&fit=crop&auto=format'
      },
      {
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        priceCents: 89990,
        stock: 12,
        imageUrl: 'https://images.unsplash.com/photo-1551698618-1dfe5d97d256?w=500&h=500&fit=crop&auto=format'
      },
      {
...
async function main() {
  console.log('🌱 Iniciando seed de la base de datos con imágenes mejoradas...')
  ...
  console.log(`📦 Total de productos: ${categories.reduce((total, cat) => total + cat.products.length, 0)}`)
}
