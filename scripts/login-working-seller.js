...
async function loginWorkingSeller() {
  try {
    console.log('🔐 Iniciando sesión con vendedor funcional...');
    
    // Usar el usuario que acabamos de crear
    const testEmail = 'vendedor.1758940040761@gmail.com';
    const testPassword = 'password123';
    
    console.log(`📧 Iniciando sesión con: ${testEmail}`);
