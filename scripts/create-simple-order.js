...
/**
 * Script para crear una orden simple de prueba
 * Ejecutar con: node scripts/create-simple-order.js
 */
...
async function createSimpleOrder() {
  console.log('🧪 Creando orden simple de prueba...');
  ...
  try {
    ...
    // 4. Crear orden simple (solo con campos básicos)
