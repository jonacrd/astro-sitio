...
/**
 * Script para procesar puntos después del checkout
 * Ejecutar con: node scripts/process-points-after-checkout.js
 */
...
async function processPointsAfterCheckout() {
  console.log('🎯 Procesando puntos después del checkout...');
  ...
  try {
    ...
    // 1. Obtener pedidos pendientes del usuario
    console.log('\n📊 1. Obteniendo pedidos pendientes...');
    ...
    if (pendingOrders.length === 0) {
      console.log('⚠️  No hay pedidos pendientes para procesar');
      return;
    }
    ...
    // 3. Procesar cada pedido pendiente
