-- Script simplificado para corregir las tablas de puntos
...
-- 2. Crear tabla points_history si no existe
...
-- 3. Crear tabla point_redemptions si no existe
...
-- 4. Crear tabla seller_rewards_config si no existe
...
-- 5. Crear tabla seller_reward_tiers si no existe
...
-- 12. Insertar configuración por defecto para vendedores existentes (sin ON CONFLICT)
...
-- 13. Insertar niveles por defecto (sin ON CONFLICT)
