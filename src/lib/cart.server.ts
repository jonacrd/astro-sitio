 ...
 */
export async function addToCart(sessionId: string, productId: number, quantity: number = 1): Promise<CartWithItems> {
 ...
 */
export async function updateCartItem(sessionId: string, productId: number, quantity: number): Promise<CartWithItems> {
  if (quantity <= 0) {
 ...
 */
export async function removeFromCart(sessionId: string, productId: number): Promise<CartWithItems> {
 ...
 */
export async function checkout(sessionId: string, customerName?: string, customerEmail?: string): Promise<{ orderCode: string; totalCents: number }> {
