...
export default function EnhancedCategoryBanner({
  ...
  return (
    <section
      className={`relative w-full ${heightClasses[height]} overflow-hidden mb-8 ${className}`}
    >
      ...
      {/* Gradient Overlay */}
      <div
        className={`absolute inset-0 bg-gradient-to-r ${gradient} bg-opacity-80`}
      ></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-white">
              ...
              <a
                ...
                className="inline-block bg-white text-gray-900 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-lg min-h-11"
              >
                Ver Todo
              </a>
            </div>
