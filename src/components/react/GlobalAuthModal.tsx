      ...
      <div className="bg-white rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={isLogin ? handleLogin : handleRegister} className="p-4 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed transition-colors font-medium flex items-center justify-center gap-3"
          >
