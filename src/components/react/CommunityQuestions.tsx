...
export default function CommunityQuestions({ questions = [] }: CommunityQuestionsProps) {
  // Datos de ejemplo si no hay preguntas reales
  const mockQuestions: Question[] = [
    {
      ...
      question: '¿Dónde puedo encontrar cachapas frescas cerca del centro?',
      timeAgo: '2h',
      answers: 3,
      featuredAnswer: {
        text: 'En la esquina de la calle 5, hay una señora que las hace todas las mañanas',
          ...
          {displayQuestions.length === 0 ? (
            ...
            <div className="space-y-3">
              {displayQuestions.map((question) => (
                <div key={question.id} className="bg-muted/30 rounded-lg p-3 hover:bg-muted/40 transition-colors">
                  {/* Header de la pregunta - Más compacto */}
                  ...
                  {/* Respuesta destacada - Más compacta */}
