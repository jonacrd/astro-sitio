  ...
  try {
    ...
    switch (testType) {
      case 'notifications':
        ...
        await notifyDeliveryConfirmed(testPhone, 'TEST_DELIVERY_001');
        await new Promise(resolve => setTimeout(resolve, 1000));
        
        await notifyPickupConfirmed(testPhone, 'TEST_DELIVERY_001');
        await new Promise(resolve => setTimeout(resolve, 1000));
        
        await notifyDeliveryOnTheWay(testPhone, 'TEST_DELIVERY_001');
        await new Promise(resolve => setTimeout(resolve, 1000));
        
        await notifyDeliveryCompleted(testPhone, 'TEST_DELIVERY_001');
      ...
      case 'delivery_flow':
        ...
        await notifyDeliveryConfirmed(testPhone, deliveryId);
        await new Promise(resolve => setTimeout(resolve, 2000));
        
        // 4. Repartidor en local (vendedor)
        await notifyPickupConfirmed(testPhone, deliveryId);
        await new Promise(resolve => setTimeout(resolve, 2000));
        ...
        // 6. Entregado (todos)
        await notifyDeliveryCompleted(testPhone, deliveryId);
